...
// VerifyAccessToken provides a mock function for the type MockAuthService
func (_mock *MockAuthService) VerifyAccessToken(ctx context.Context, accessToken string) (string, error) {
...
// MockAuthService_VerifyAccessToken_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VerifyAccessToken'
type MockAuthService_VerifyAccessToken_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - accessToken string
func (_e *MockAuthService_Expecter) VerifyAccessToken(ctx interface{}, accessToken interface{}) *MockAuthService_VerifyAccessToken_Call {
	return &MockAuthService_VerifyAccessToken_Call{Call: _e.mock.On("VerifyAccessToken", ctx, accessToken)}
}

func (_c *MockAuthService_VerifyAccessToken_Call) Run(run func(ctx context.Context, accessToken string)) *MockAuthService_VerifyAccessToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockAuthService_VerifyAccessToken_Call) Return(s string, err error) *MockAuthService_VerifyAccessToken_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockAuthService_VerifyAccessToken_Call) RunAndReturn(run func(ctx context.Context, accessToken string) (string, error)) *MockAuthService_VerifyAccessToken_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockLLMAPIKeyService) ListByUserID(ctx context.Context, userID string) ([]*LLMAPIKey, error) {
	...
	var r0 []*LLMAPIKey
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) ([]*LLMAPIKey, error)); ok {
		return returnFunc(ctx, userID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) []*LLMAPIKey); ok {
...
func (_c *MockLLMAPIKeyService_ListByUserID_Call) Run(run func(ctx context.Context, userID string)) *MockLLMAPIKeyService_ListByUserID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockLLMAPIKeyService_ListByUserID_Call) RunAndReturn(run func(ctx context.Context, userID string) ([]*LLMAPIKey, error)) *MockLLMAPIKeyService_ListByUserID_Call {
	_c.Call.Return(run)
	return _c
}
